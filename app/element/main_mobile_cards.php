...
<div class="row">
        <div class="col s12 m8">
          <div class="card">
            <div class="card-image">
              <?php echo '<a href="recipe.php?id='.$day_recipe_id.'"><img src="../app/images/recipes/'.$day_recipe_pic.'" style="height:250px;"></a>'; ?>
        ...
        <div class="col s12 m4">
          <div class="card">
            <div class="card-image">
              <?php echo '<a href="recipe.php?id='.$sponsor_recipe_id.'"><img src="../app/images/recipes/'.$sponsor_recipe_pic.'" style="height:250px;"></a>'; ?>
        ...
        <div class="col s12 m4">
          <div class="card">
            <div class="card-image">
             <?php echo '<a href="recipe.php?id='.$second_sponsor_recipe_id.'"><img class="responsive-img" src="../app/images/recipes/'.$second_sponsor_recipe_pic.'" style="height:250px;"></a>'; ?>
